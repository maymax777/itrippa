...
export default class ResetPassswordScreen extends Component<Props> {
        ...
        <Container style={{backgroundColor:'#F8F8F8'}}>       
            ...
            <Grid >  
              ...
              <Col size={84} >
                <Row size={2}>
                  <Col>
                    <Text style={[styles.title_text, {color:colors.pink}]}>Reset your Password</Text>
                ...
                <Row size={2}>
                  <Col>
                    ...
                    <Button large block style={[{backgroundColor:colors.pink}, styles.vertical_space]} onPress={() => {this.props.navigation.navigate('SetNewPassword')}}>
			            <Text style={[styles.button_text, {color:colors.white}]}>Reset Password</Text>
			        </Button>
                  </Col>
                </Row>                
